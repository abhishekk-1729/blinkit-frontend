...
export const AuthProvider = ({ children }) => {
    ...
    if (token) {
      try {
        const response = await fetch(
          "https://abhishek.nssiitd.in/ecommerce/api/auth/user",
          {
            method: "GET",
            headers: {
  ...
  const getAllProducts = async () => {
    try {
      const response = await fetch(
        "https://abhishek.nssiitd.in/ecommerce/api/products/getAllProducts",
        {
          method: "GET",
        }
      );
  ...
  const getAllCategory = async () => {
    try {
      const response = await fetch(
        "https://abhishek.nssiitd.in/ecommerce/api/products/getAllCategory",
        {
          method: "GET",
        }
      );
  ...
  const fetchAddress = async () => {
    try {
      // console.log(phone);
      const response = await fetch(
        `https://abhishek.nssiitd.in/ecommerce/api/address/getAddressPhone/${phone}`,
        {
          method: "GET",
        }
      );
