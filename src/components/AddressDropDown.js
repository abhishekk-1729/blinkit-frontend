...
export default function AddressDropDown({dropdownRef,setAddress}) {
  ...
  return (
    <div>
      <div ref={dropdownRef} className='address-dropdown w-1/3 z-2 mx-20 p-6 flex flex-col  bg-[#F3F6FB]'>
