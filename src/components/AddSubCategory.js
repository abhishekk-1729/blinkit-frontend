...
<div class="py-10 flex justify-center">
  <form onsubmit= {handleSubmit} class="bg-white p-6 rounded-md shadow-md w-full max-w-sm">
    <div class="mb-4">
      <label for="category-name" class="block text-sm font-medium text-gray-700">Sub Category Name</label>
    ...
    <div class="mb-4">
      <label for="category-image" class="block text-sm font-medium text-gray-700">Sub Category Image</label>
